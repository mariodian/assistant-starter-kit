...
Your main workspace is `~/claude-assistant/`. Start sessions with `cd ~/claude-assistant && opencode`.

All knowledge, tasks, skills, state, and agents live in the workspace. Rules and security hooks are in `~/.claude/`.
